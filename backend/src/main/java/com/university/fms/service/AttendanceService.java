...
public class AttendanceService {
    ...
    public AttendanceDto markAttendance(AttendanceDto dto) {
        ...
        if (attendanceRepository
                .findByFacultyIdAndAttendanceDate(dto.getFacultyId(), dto.getAttendanceDate())
                .isPresent()) {
            throw new BadRequestException("Attendance already marked for "
                    + dto.getFacultyId() + " on " + dto.getAttendanceDate());
        }
    ...
    public List<AttendanceDto> getMonthlyAttendance(Long facultyId, int year, int month) {
        ...
        return attendanceRepository
                .findByFacultyIdAndAttendanceDateBetween(facultyId, from, to)
